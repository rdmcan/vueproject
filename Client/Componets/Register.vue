...
Brief: Display the register and set rules and methods for login  -->
    ...
    <v-row flex align-center>
      <v-col xs12 sm4 elevation-6>
        <v-card style="height:75vh;">
          <v-card-title class="justify-center display-1 indigo--text">Register</v-card-title>
            ...
            <div>
              <v-form v-model="valid" ref="form">
                ...
                <v-row justify="center">
                  <v-btn
                    @click="register"
                    :class=" { 'indigo darken-3 white--text': valid, disabled: !valid }"
...
export default {
  ...
  data() {
    return {
      ...
      }, // Specified the individual rules
      valid: false,
      status: ""
    };
  },
